...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(Motor1_Encoder1), docount_right1, CHANGE);  // increase counter when speed sensor pin goes High
  attachInterrupt(digitalPinToInterrupt(Motor2_Encoder1), docount_left2, CHANGE);  // increase counter when speed sensor pin goes High
  attachInterrupt(digitalPinToInterrupt(Motor3_Encoder1), docount_left3, CHANGE);  // increase counter when speed sensor pin goes High
  attachInterrupt(digitalPinToInterrupt(Motor4_Encoder1), docount_right4, CHANGE);  // increase counter when speed sensor pin goes High
