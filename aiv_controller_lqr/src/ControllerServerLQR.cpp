...
void executeCB(const aiv_controller_lqr::lqrGoalConstPtr& goal)
{
  prevTime = ros::Time::now();
	...
	while(1)
	{
		...
		//LQR Controller
		msg_vel1.data = -13.959*th_dot_goal - 0.791*th_dot_d - 14.533*x_dot_goal -  0.791*x_dot_d -  14.533*y_dot_goal - 0.791*y_dot_d;
		msg_vel2.data = 13.959*th_dot_goal +  0.791*th_dot_d - 14.533*x_dot_goal -  0.791*x_dot_d +  14.533*y_dot_goal + 0.791*y_dot_d;
		msg_vel3.data =13.959*th_dot_goal +  0.791*th_dot_d - 14.533*x_dot_goal -  0.791*x_dot_d -  14.533*y_dot_goal - 0.791*y_dot_d;
		msg_vel4.data =	-13.959*th_dot_goal -  0.791*th_dot_d - 14.533*x_dot_goal -  0.791*x_dot_d +  14.533*y_dot_goal + 0.791*y_dot_d; 

/*
		//LQR Controller
		msg_vel1.data = -8.090*th_dot_goal - 19.3548*x_dot_goal - 19.3548*y_dot_goal;
		msg_vel2.data = 8.090*th_dot_goal - 19.3548*x_dot_goal + 19.3548*y_dot_goal;
		msg_vel3.data = 8.090*th_dot_goal- 19.3548*x_dot_goal - 19.3548*y_dot_goal;
		msg_vel4.data =	-8.090*th_dot_goal - 19.3548*x_dot_goal + 19.3548*y_dot_goal;
